								...
								<article class="post hentry slides demo-image displayblock">
									<figure class="slider-image">
										<a title="Slider Image 1" href="'. esc_url( home_url( '/' ) ) .'">
											<img src="'.get_template_directory_uri().'/images/gallery/xcareers-1200x400.png" class="wp-post-image" alt="travailler" title="Travailler">
										</a>
									</figure>
									<div class="entry-container">
										<header class="entry-header">
											<h1 class="entry-title">
												<a title="Travailler" href="#"><span>Travailler</span></a>
											</h1>
										</header>
										<div class="entry-content">
											<p>Travailler avec le numérique</p>
										</div>   
									</div>             
								</article><!-- .slides --> 	
								...
								<article class="post hentry slides demo-image displaynone">
									<figure class="Slider Image 2">
										<a title="Slider Image 2" href="'. esc_url( home_url( '/' ) ) .'">
											<img src="'. get_template_directory_uri() . '/images/gallery/xtraining-1200x400.png" class="wp-post-image" alt="Apprendre" title="Apprendre">
										</a>
									</figure>
									<div class="entry-container">
										<header class="entry-header">
											<h1 class="entry-title">
												<a title="Apprendre" href="#"><span>Apprendre</span></a>
											</h1>
										</header>
										<div class="entry-content">
											<p>Apprendre avec le numérique</p>
										</div>   
									</div>             
								</article><!-- .slides -->
								...
								<article class="post hentry slides demo-image displaynone">
									<figure class="Slider Image 3">
										<a title="Slider Image 3" href="'. esc_url( home_url( '/' ) ) .'">
											<img src="'. get_template_directory_uri() . '/images/gallery/xlipped_classroom-1200x400" class="wp-post-image" alt="Changer la classe" title="Changer la classe">
										</a>
									</figure>
									<div class="entry-container">
										<header class="entry-header">
											<h1 class="entry-title">
												<a title="Changer la classe" href="#"><span>Changer la classe</span></a>
											</h1>
										</header>
										<div class="entry-content">
											<p>Changer la classe avec un ENT</p>
										</div>   
									</div>             
								</article><!-- .slides -->';
